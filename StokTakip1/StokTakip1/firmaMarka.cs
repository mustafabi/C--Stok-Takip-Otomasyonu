...
{
    public partial class firmaMarka : Form
    {
        public firmaMarka()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand komut = new SqlCommand("insert into markabilgileri(marka) values('" + comboBox1.Text + "','" + textBox1.Text + "')", baglanti);
        ...
        private void firmaMarka_Load(object sender, EventArgs e)
        {
            kategorigetir();
        }
    }
